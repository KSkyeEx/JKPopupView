...
//  JKPopupView
//
//  Created by weij on 04/18/2020.
//  Copyright (c) 2020 weij. All rights reserved.
//
...
#pragma mark - UIJKViewController
...
- (void)navigationController:(UINavigationController *)navigationController willShowJKViewController:(UIViewController *)JKViewController animated:(BOOL)animated {
    
    // If this is a field table, make sure the selected row is scrolled into view when it appears.
    if ((navigationController == self.presentedViewController) && [JKViewController.view isKindOfClass:[UITableView class]]) {
        
        UITableView *fieldTableView = (UITableView*)JKViewController.view;
